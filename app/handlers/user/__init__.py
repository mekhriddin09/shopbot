...
from app.handlers.user import card_auto, language, onboarding, orders, referral, reviews, shop, start, stars, support
...
user_router.include_router(card_auto.router)
